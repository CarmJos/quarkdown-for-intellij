...
import cc.carm.plugin.intellij.quarkdown.lang.editor.QuarkdownGraphicsUtils.clearHalfOvalOverEditor
import cc.carm.plugin.intellij.quarkdown.lang.editor.QuarkdownGraphicsUtils.fillHalfOval
...
internal class QuarkdownVerticalBarPresentation(
    ...
    private fun showToolbar() {
        val targetComponent = ToolbarUtils.createTargetComponent(editor) { sink ->
            QuarkdownTableActionKeys.putRowSnapshot(sink, block, rowIndex)
        }
    ...
    companion object {
        ...
        fun create(factory: PresentationFactory, editor: Editor, block: QuarkdownTableModificationUtils.TableBlock, rowIndex: Int): InlayPresentation {
