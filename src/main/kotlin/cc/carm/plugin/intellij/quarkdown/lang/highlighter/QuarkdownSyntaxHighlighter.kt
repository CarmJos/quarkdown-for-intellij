...
class QuarkdownSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    companion object {
        ...
        // ---- Element ID tag {#id} ----
        val ID_TAG_MARKER = TextAttributesKey.createTextAttributesKey(
            "QUARKDOWN_ID_TAG_MARKER", DefaultLanguageHighlighterColors.KEYWORD
        )
        ...
        val SEMANTIC_VALID_ENUM = TextAttributesKey.createTextAttributesKey(
            "QUARKDOWN_SEMANTIC_VALID_ENUM", DefaultLanguageHighlighterColors.STRING
        )

        /** Applied to resolved parameter names in named arguments. */
        val SEMANTIC_PARAMETER = TextAttributesKey.createTextAttributesKey(
            "QUARKDOWN_SEMANTIC_PARAMETER", DefaultLanguageHighlighterColors.PARAMETER
        )
        ...
        private val KEYS: Map<IElementType, TextAttributesKey> = mapOf(
            ...
            // Element ID tag {#id}
            QuarkdownTokenTypes.ID_TAG_MARKER to ID_TAG_MARKER,
