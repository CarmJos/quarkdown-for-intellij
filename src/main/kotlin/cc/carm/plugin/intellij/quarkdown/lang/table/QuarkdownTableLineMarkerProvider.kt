    ...
    inner class TableGutterHandler : GutterIconNavigationHandler<PsiElement> {
        ...
        override fun navigate(e: MouseEvent, elt: PsiElement) {
            ...
            if (dialog.showAndGet()) {
                ...
                // replacement never uses stale offsets.
                val current = QuarkdownTableModificationUtils.findTableBlocks(document.immutableCharSequence)
                    .firstOrNull { it.startOffset == block.startOffset } ?: block
